...
public class AvailableFlightsPage {
    ...
    public static final Target SHORT_DURATION_OPTION = Target.the("Option from the list, shortest duration").locatedBy("//option[@data-opt-id='DURATION_INCREASING']");
    public static final Target EARLY_DEPARTURE_OPTION = Target.the("Option from the list, earliest departure").locatedBy("//option[@data-opt-id='DEPARTURE_INCREASING']");
    ...
    public static final Target DEPARTURE_FLIGHT_TIME_SELECTED = Target.the("Time and duration of the flight").locatedBy("(//div//span[@aria-hidden='true'])[2]");
    public static final Target RETURN_FLIGHT_TIME_SELECTED = Target.the("Time and duration of the flight").locatedBy("(//div//span[@aria-hidden='true'])[3]");
